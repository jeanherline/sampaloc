    ...
    <div class="container">
        ...
        <div class="main-body">
            <div class="promo_card">
                ...
                ?>
                <h1>Account Credentials
                </h1>
            </div>
            <?php
            include("config.php");
            $getVal = "SELECT * FROM tblresidents INNER JOIN tblaccess
            ON tblresidents.aID=tblaccess.aID 
            WHERE tblresidents.aID= '$aID'";
            ...
            <div class="list">
                <div class="list1">
                    <div class="row">
                        ...
                        <div class="add">
                            <a href="credentials.php"><button>Change Login Credentials</button></a>
                        </div>
                    </div>
                    <div class="wrapper">
                        <header>
                        ...
                        <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
                            <div class="left">
                                ...
                                <input type="file" id="rImage" name="rImage" accept=".jpg,.jpeg,.png"
                                    value="<?= $rImage ?>">
