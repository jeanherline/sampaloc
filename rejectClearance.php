                ...
                <div class="list1">
                    ...
                    <div class="wrapper">
                        <form action="" method="post">
                            ...
                            <textarea rows="10" cols="50" id="pFindings" name="cFindings"
                        ...
                        if (isset($_POST['save'])) {
                            ...
                            $query = "UPDATE tblclearance SET cAmount = 'N/A', cStatus = 'Declined', cFindings = '$cFindings' WHERE cID = '$cID'";
                            ...
                            if ($result) {
                                ...
                                $body = "<h3><font color=red>Your Requested Clearance has been Declined. </font color></h3><br>
                                You may check your clearance request in the Barangay Sampaloc Portal by logging in to your account.
                                Kindly view your clearance request for further details. <br>
                                <h4> You may request for another clearance once you have resolved
                                ...
                                $mail->Subject = "Clearance Request Declined";
                                $mail->Body = $body;
